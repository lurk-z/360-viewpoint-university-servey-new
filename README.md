...
## ห้องพวงแสดและห้องตัวอย่างชั้น 4

- จากฉาก `fitmInterior1` (`temp-faculty-1.jpg`) กดลูกศรที่ประตูเพื่อเข้าห้องพวงแสด (`temp-puang-saed.jpg`) และกดลูกศรในห้องเพื่อกลับทางเดิม
- ในแผงข้อมูลฉากภายใน FITM เปิด **ห้องเรียนตัวอย่าง** เพื่อเลือกห้องเรียน **4-20 (120 ที่นั่ง)** หรือ **ห้องปฏิบัติการ 4-01A และ 4-01B** ซึ่งใช้ภาพตัวอย่างร่วมกันตามข้อมูลโครงการ
- เมื่ออยู่ชั้น 4 เมนูเลือกห้อง 4-20 ให้ก่อน รูปตัวอย่างโหลดเมื่อเปิดเมนูและไม่เพิ่มลงในเส้นทางเดิน

การเพิ่มห้องพวงแสดไปยังฐานข้อมูลอีกสภาพแวดล้อม ให้ตรวจรายการเปลี่ยนแปลงก่อนแล้วจึงซิงก์:

```bash
npm run sync:tour -- --puang-saed-only --dry-run
npm run sync:tour -- --puang-saed-only
```

ตัวเลือกนี้เพิ่มเฉพาะห้องพวงแสดและลูกศรไป–กลับใน Draft/Published เก็บ Revision ก่อนแก้ และปรับเฉพาะ Baseline ของลูกศรสองจุดนี้ ไม่รันการแก้ข้อมูลหอพักหรือเก็บ Info เข้าคลังจากชุดอัปเดตเก่า หากพบ ID หรือเส้นทางชนจะหยุดก่อนแก้โครงสร้าง และการซิงก์ซ้ำไม่เพิ่มเวอร์ชัน
